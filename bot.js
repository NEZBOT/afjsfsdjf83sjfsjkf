...
!!botserver : لعرض السيرفرات الي داخل فيها البوت
...
!!id : لاظهار معلومات حسابك

!!mcskin : لاظهار سكنك في ماين كرافت

!!avatar : لاظهار صورتك في دسكورد

!!لاقتراح شي للبوت :اقتراح

!!bot : لاظهار معلومات البوت

!!color : لانشاء 50 لون

!!color لاختيار لون محدد : لون معين

 فقط سوي روم اسمه log : لوق
 
 !!mute : لاعطاء شخص ميوت
 
 !!unmute : عشان توخر الميوت من شخص

!!لعبة : صراحه

!!لعبة : نكت

!!play : عشان تسمح اغنية , ميوزك
...
if(!message.author.id === '514876883951943733') return;
message.channel.sendMessage('لقد تم ارسال الرساله |:white_check_mark:')
...
client.on('message', message => {
    ...
    .setURL(`https://discordapp.com/oauth2/authorize?client_id=535405431879892992&permissions=8&scope=bot`)
    .setThumbnail("https://cdn.discordapp.com/attachments/535410692019191811/535440227091611648/NEZ_BOT.png")        
 message.channel.sendEmbed(embed);
   }
});
...
client.on('message',  message => {
  if(bannedwords.some(word => message.content.includes(word))) {
    message.delete()
    message.reply(" **احترم نفسك انت في مكان راقي**   ").then(msg => {msg.delete(5000)});;
  };
});
...
client.on(`ready`, ()=>{
  client.setInterval(async function(){
    let ch = client.guilds.get("535410692019191808").channels;
    let count = 0;
    ...
    setTimeout(function(){
      ch.get("535512867747921921").setName(`Online 「${count}」`)//count = عدد الاشخاص
    }, 500)
  }, 1000)
})
...
client.on('guildMemberAdd', member => {
  ...
  channel.send(`**Welcome to Nez Bot Support**, ${member}`);
});
...
client.on('message', message => {
  if(message.content.includes('discord.gg')){
      ...
      message.delete()
  return message.reply(`** يمنع النشر في السيرفر **`)
  }
}
});
...
client.on('message', message => {
    ...
    if(message.content.split(' ')[0] == '!!اقتراح'){ //حقوق ناروكس
        if (message.author.bot) return;
     
                            let args = message.content.split(' ').slice(1).join(' ');
                                 if (!args) return message.reply("**!اكتب الرسالة**");//حقوق ناروكس
      ...
      let embed = new Discord.RichEmbed()
                                                    ...
                                                    .addField("**- المرسل :**", message.author.username)
                                                        .addField("**- اي دي المرسل :**", message.author.id)
                                                    .addField("**- الاقتراح :**", args)//حقوق ناروكس
                                                    .setColor("FF0000")
                                                    .setFooter(message.author.username, message.author.avatarURL)
                                                   
                                                   
     client.channels.get("535461262818017290").send({ embed: embed }); //ايدي الروم هنا
...
client.on('message', message => {
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('**Bot Owner**👑 :' , `[<@514876883951943733>]` , true)
            .setFooter(message.author.username, message.author.avatarURL)
    })
}
});
...
client.on('guildCreate', guild => {
  ...
  client.users.get("514876883951943733").send(
    "\n" + "**" + " ● دخلت سيرفر جديد : " + "**" +
    "\n" + "**" + "● سيرفر :" + "**" +
    "\n" + "**" + "» " + guild.name + "**" +
    "\n" + "**" + " ● اي دي : " + "**" +
...
client.on("ready", () => { 
console.log('By : MJH-OoL'); client.user.setPresence({ 
       status: 'online', 
       game: { type: 0, name: '!!help I By MJH-OoL',
      ...
      assets: { 
small_image: `514876883951943733`, 

small_text: 'Nez Bot', 
large_image: `514876883951943733`, large_text: `Nez Bot` } 
...
client.on('message' , DâRK => { //Coded By Narox & DâRKNîghT#1001
  var Narox ="-" //prefix bot
    if(DâRK.content.startsWith('<@535405431879892992>')) //id bot
     var Dark = new Discord.RichEmbed()
    .setColor('RANDOM')
    .setDescription(`Hey Im **${client.user.username}!**`)
    .addField('برفكس البوت' , `!!` ,true)
    .addField('اوامر البوت' , `!!help` ,true)
    .addField('لاضافة البوت لسيرفرك' , `!!invite` ,true)
    .addField('سيرفر السبورت' , `https://discord.gg/PjVgSrw` ,true)
    .addField('صانع البوت' , `<@514876883951943733>` ,true) //Coded By Narox & DâRKNîghT#1001
  .setTimestamp()
